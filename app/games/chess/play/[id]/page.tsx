...
export default function ChessGamePage() {
  ...
  const playerColor =
    game.player1_wallet === publicKey?.toBase58() ? 'white' : 'black';
        ...
        {isSimulation && (
          <div className="glass-card rounded-xl p-4 mb-6 bg-blue-500/10 border-2 border-blue-500">
            <p className="text-sm text-blue-300">
              <strong>🧪 Simulation Mode:</strong> You control both players for testing. Make moves
              for both white and black to test the complete gameplay flow.
            </p>
          </div>
        )}
